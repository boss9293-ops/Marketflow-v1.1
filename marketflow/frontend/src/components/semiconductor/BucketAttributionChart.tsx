        ...
        <>
          ...
          <div style={{ background: '#0f172a', border: '1px solid #1e293b', borderRadius: 8,
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center',
              marginBottom: 8, fontSize: 11, color: '#64748b', letterSpacing: 1.2 }}>
          ...
          <div style={{ background: '#0f172a', border: '1px solid #1e293b', borderRadius: 8,
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center',
              marginBottom: 8 }}>
              <span style={{ fontSize: 11, color: '#64748b', letterSpacing: 1.2 }}>
          ...
          <div style={{ background: '#0f172a', border: '1px solid #1e293b', borderRadius: 8,
            ...
            {hmBuckets.map(({ key, label, color }) => (
              <div key={key} style={{ display: 'flex', alignItems: 'center', gap: 4, marginBottom: 2 }}>
                <div style={{ fontSize: 11, color, width: 72, textAlign: 'right', flexShrink: 0 }}>
                  {label}
                </div>
            ...
            <div style={{ display: 'flex', gap: 1.5, paddingLeft: 76, marginTop: 4 }}>
              {history.map((pt, i) => (
                <div key={i} style={{ flex: 1, fontSize: 11, color: '#475569', textAlign: 'center',
          ...
          <div style={{ background: '#0f172a', border: '1px solid #1e293b', borderRadius: 8,
            padding: '11px 14px', marginBottom: 8 }}>
            <div style={{ fontSize: 11, color: '#64748b', letterSpacing: 1.2, marginBottom: 10 }}>
