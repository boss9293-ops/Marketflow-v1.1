...
// Breadth % (0~100 direct, centered at 50, scaled to 짹100 signal)
// positive direction
...
export function normalizeMetrics(
  ...
  // Translate to top5pct proxy: 50% baseline + relative delta
  ...
  metrics.push({
    id: 'yield_10y_change_30d', name: '10Y Yield ?30D',
