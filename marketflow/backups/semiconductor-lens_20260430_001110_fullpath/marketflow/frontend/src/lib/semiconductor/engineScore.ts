...
function detectConflicts(
  ...
  // MOMENTUM_DIVERGENCE: price rising but momentum weakening
  ...
  // AI_INFRA_SUSTAINABILITY_RISK: extreme AI concentration without broad support
...
function detectPrimaryRisk(
  ...
  const weakLabels: Record<string, string> = {
    price_trend:  'Price trend weakening',
