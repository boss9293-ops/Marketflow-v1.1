                  ...
                  {liveSignals.map((s, i) => {
                    ...
                    return (
                      <div key={i} style={{ background: BG.bg2, border: `1px solid ${BG.border}`, borderRadius: 3, padding: '5px 7px', display: 'flex', flexDirection: 'column', gap: 2 }}>
                        ...
                        <span style={{ fontSize: 10, fontWeight: 700, padding: '1px 5px', borderRadius: 2, background: strBg, color: strColor, display: 'inline-block' }}>{strLabel}</span>
                        <span style={{ fontSize: 10, color: CLR.dim, lineHeight: 1.3 }}>{s.sub}</span>
                      </div>
                    )
                  })}
                </div>
