  ...
  return (
    <div className="flex flex-col gap-2.5 text-[11px]">
      ...
      <div className="pb-2 border-b border-slate-800/60">
        ...
        <p className="text-slate-200 font-medium leading-snug">{data.summary}</p>
      </div>
      ...
      {/* Supporting */}
      <div className="pb-2 border-b border-slate-800/60">
        <div className="text-[11px] text-slate-400 uppercase tracking-widest mb-1">Supporting Structure</div>
        <ul className="space-y-0.5">
          {data.support.map((s, i) => (
            <li key={i} className="flex items-start gap-1 text-slate-400">
      ...
      {/* Weakening */}
      <div className="pb-2 border-b border-slate-800/60">
        <div className="text-[11px] text-slate-400 uppercase tracking-widest mb-1">Weakening Structure</div>
        <ul className="space-y-0.5">
      ...
      {/* Interpretation */}
      <div className="pb-2 border-b border-slate-800/60">
        <div className="text-[11px] text-slate-400 uppercase tracking-widest mb-1">Structural Interpretation</div>
        <p className="text-slate-300 leading-snug">{data.interpretation}</p>
      </div>

      {/* Historical Context */}
      {data.context && (
        <div>
          <div className="text-[11px] text-slate-400 uppercase tracking-widest mb-1">Historical Context</div>
          <p className="text-slate-500 leading-snug italic">{data.context}</p>
        </div>
      )}
...
export default function SemiconductorPlaybackTab() {
  ...
  return (
    <div className="flex flex-col gap-4 px-4 py-4 max-w-[1280px] mx-auto">
      ...
      {/* ?™몿 Charts side by side */}
      <div className="grid grid-cols-2 gap-4">

        {/* ??Rebased 100 Chart */}
        <div className="border border-slate-800 bg-[#04070d] rounded-sm p-4">
          <SectionLabel n={3} text="Rebased 100 Chart" />
          <div className="text-[11px] font-bold text-slate-300 uppercase tracking-widest mb-3">
      ...
      {/* ??Data Status */}
      <div className="border border-slate-800/50 bg-slate-900/20 rounded-sm px-4 py-2.5 flex flex-wrap items-center gap-3">
